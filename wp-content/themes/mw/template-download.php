...
<?php while ( have_posts() ) : the_post(); ?>
    ...
    <?php $i = 1; if( get_field('downloads') ) { if( get_field('downloads') ) { ?>
        <div class="list-downloads d-flex justify-content-center pt-5 pb-5">
            <div class="col-12 col-lg-10 col-xl-10 d-flex justify-content-around row">
                <?php while( has_sub_field('downloads') ){ ?>
                    <div class="text-center col-12 col-lg-4 mb-5 item-<?php echo $i; ?>">
                        <?php if( get_sub_field('file') ) { ?>
                            ...
                            <a href="<?php echo get_sub_field('file')['url']; ?>" title="<?php echo get_sub_field('file')['title']; ?>" download>SCARICA</a>
                        <?php } ?>
